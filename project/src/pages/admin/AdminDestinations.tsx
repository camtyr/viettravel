      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-4">
          <p className="text-gray-600">
            Hiển thị <span className="font-semibold">{filteredDestinations.length}</span> địa điểm
          </p>
        </div>
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex flex-wrap items-center gap-4 text-sm text-gray-500">
                          <div className="flex items-center">
                            ...
                            <span>ID: {destination.createdById}</span>
                          </div>
                          <div className="flex items-center">
                          ...
                          <div className="flex items-center">
                            ...
                            <span className="ml-1">({destination.ratingCount} đánh giá)</span>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-wrap items-center gap-3 pt-4 border-t border-gray-200">
                      ...
                      {destination.status === 'Pending' && (
                        <>
                          ...
                          <button
                            onClick={() => handleReject(destination.id)}
